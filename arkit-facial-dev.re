...
続けて、ARKit Face Trackingの機能をつかって、3Dキャラクターを動かすアバターアプリをつくってみましょう。
...
ARKit Face Tracking API群としては色々なことができるのですが、3Dモデルに適用して遊ぶ際には「顔の向き・目・口」のみを扱うようにだけ絞ると、実装をかんたんにすることができます。
...
ARKit Face Trackingのトラッキング結果をどう扱うか決めたあとは、最終的に3Dモデルに適用します。
